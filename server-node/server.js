...
app.get('/albums', function (req, res) {
    res.send(albums) //Va renvoyer la liste des albums du groupe
});

app.get('/members', function (req, res) {
    res.send(members) //Va renvoyer la liste des membres du groupe
});

app.get('/concertTours', function (req, res) {
    res.send(concertTours) //Va renvoyer la liste des des concerts
});

app.get('/labels', function (req, res) {
    res.send(labels) //Va renvoyer la liste des labels
});